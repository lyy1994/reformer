...
from fairseq.data import (
    data_utils, Dictionary, DecoderDataset, IndexedInMemoryDataset,
...
@register_task('decoder_translation')
class DecoderTranslationTask(FairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        # load dictionaries
        print("| \033[0;33;0mMake sure that you have a joint dictionary!\033[0m")
    ...
    def load_dataset(self, split, combine=False):
        ...
        self.datasets[split] = DecoderDataset(
